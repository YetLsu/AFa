...
@interface YYOfficColdLifeController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation YYOfficColdLifeController
...
//获取所有文章
- (void)getAllArticles{
    NSString *urlStr = @"http://www.sxeto.com/fruitApp/Buyer?mode=31&category=1";
...
- (instancetype)initWithTableViewHeight:(CGFloat)height{
    if (self = [super init]) {
        ...
        [self getAllArticles];
        //self.lifeTableView.backgroundColor = [UIColor yellowColor];
