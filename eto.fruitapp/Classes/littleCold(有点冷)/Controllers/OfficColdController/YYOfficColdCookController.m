...
@interface YYOfficColdCookController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation YYOfficColdCookController
...
//获取所有文章
- (void)getAllArticles{
    NSString *urlStr = @"http://www.sxeto.com/fruitApp/Buyer?mode=31&category=2";
...
- (instancetype)initWithTableViewHeight:(CGFloat)height{
    if (self = [super init]) {
        ...
        //self.cookTableView.backgroundColor = [UIColor greenColor];
        [self getAllArticles];
