...
- (void)viewDidLoad {
    [super viewDidLoad];
    //1月4日修改
//    YYHomeNewViewController *home = [[YYHomeNewViewController alloc] init];
...
//    [UIImage imageNamed:@"tabbar_profile_high"]@"我的"
    ...
    self.profile = [self addChildControllerWithChildController:profile image:[UIImage imageNamed:@"tabbar_profile_normal"] selectImage:[UIImage imageNamed:@"tabbar_profile_high"] title:@"我的"];
        ...
        self.profile = [self addChildControllerWithChildController:goLogin image:[UIImage imageNamed:@"tabbar_profile_normal"] selectImage:[UIImage imageNamed:@"tabbar_profile_high"] title:@"我的"];
    }
