...
@interface YYCookSearchViewController ()<UITableViewDelegate,UITableViewDataSource,YYCircleTableViewCell2Delegate>
@property (nonatomic,strong) NSMutableArray *modelArrays2;//假数据
@property (nonatomic,assign) CGFloat rowHeight;
@property (nonatomic,strong) AFHTTPRequestOperationManager *manager;
@end

@implementation YYCookSearchViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.delegate respondsToSelector:@selector(cookCellClickWithModel:)]) {
        [self.delegate cookCellClickWithModel:model];
    }
}
...
- (void)getContentCell{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://www.sxeto.com/fruitApp/Buyer.php?mode=21&category=%d&buid=%@",2,account.userUID];
    YYLog(@"%@",urlStr);
