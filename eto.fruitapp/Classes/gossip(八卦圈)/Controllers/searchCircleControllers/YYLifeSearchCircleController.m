//
//  YYSearchCircleLifeTableViewController.m
//  圈子_V1
//
...
@interface YYLifeSearchCircleController () <UITableViewDelegate,UITableViewDataSource,YYCircleTableViewCell2Delegate>
...
@implementation YYLifeSearchCircleController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.delegate respondsToSelector:@selector(lifeCellClickWithModel:)]) {
        [self.delegate lifeCellClickWithModel:model];
    }
}
...
- (void)getContentCell{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://www.sxeto.com/fruitApp/Buyer.php?mode=21&category=%d&buid=%@",1,account.userUID];
    YYLog(@"%@",urlStr);
