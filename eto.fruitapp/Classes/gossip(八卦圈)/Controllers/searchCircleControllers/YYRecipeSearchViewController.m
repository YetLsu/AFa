//
//  YYRecipeSearchViewController.m
//  eto.fruitapp
//
...
@interface YYRecipeSearchViewController ()<UITableViewDelegate,UITableViewDataSource,YYCircleTableViewCell2Delegate>
@property (nonatomic,strong) NSMutableArray *modelArrays2;//假数据
@property (nonatomic,assign) CGFloat rowHeight;
@property (nonatomic,strong) AFHTTPRequestOperationManager *manager;
@end

@implementation YYRecipeSearchViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.delegate respondsToSelector:@selector(recipeCellClickWithModel:)]) {
        [self.delegate recipeCellClickWithModel:model];
    }
}
...
- (void)getContentCell{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://www.sxeto.com/fruitApp/Buyer.php?mode=21&category=%d&buid=%@",4,account.userUID];
    YYLog(@"%@",urlStr);
