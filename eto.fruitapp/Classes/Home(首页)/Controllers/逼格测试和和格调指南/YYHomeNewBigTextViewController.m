...
@interface YYHomeNewBigTextViewController () <UITableViewDataSource,UITableViewDelegate>
...
@implementation YYHomeNewBigTextViewController
...
- (void)getModels{
    ...
    [self.manager GET:@"http://www.sxeto.com/fruitApp/Buyer.php?mode=3&category=1" parameters:nil success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject) {
