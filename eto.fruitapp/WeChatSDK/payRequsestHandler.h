...
#define APP_ID          @"wx59efa52c43efd39a"               //APPID
#define APP_SECRET      @"34c880d225812e16482c470410367270" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1281725801"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"ZzExRgONE01ZG12zj34sx56eto789cpb"
//支付结果回调页面
